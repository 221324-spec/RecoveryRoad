...
export default function CausesOfDrugAddiction() {
      ...
      <footer className="dashboard-footer">
        <div className="footer-container">
          <div className="footer-brand">
            <img src={RecoveryRoadLogo} alt="Recovery Road Logo" className="footer-logo" loading="lazy" />
            <p>
              Recovery Toolkit provides educational resources and supportive tools to
              promote awareness, prevention, and recovery from drug addiction.
            </p>
          </div>
