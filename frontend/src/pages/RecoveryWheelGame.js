...
export default function RecoveryWheelGame() {
  ...
  // Navigation handlers
  const handleStartFlashcards = () => navigate("/flashcards");
  const handleStartGrounding = () => navigate("/groundingexercise");
  const handleStartTrivia = () => navigate("/triviagame");
  const handleStartImagePuzzle = () => navigate("/imagepuzzle");
  const handleStartMotivationBuilder = () => navigate("/motivationbuilder");
  const handleStartMoodPop = () => navigate("/moodpop");
