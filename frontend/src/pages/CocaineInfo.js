...
import CocaineImage from "../assets/cbg.jpg"; // placeholder image
import Substance from "../assets/sc.jpg";
//import Cocaine from "../assets/cocaine.png"; // placeholder image

import "./CocaineInfo.css"; 

function CocaineInfo() {
    ...
    <div className="alcohol-info-layout">
      ...
      <main className="main-container">
        ...
        <section className="hero">
          <img src={CocaineImage} alt="Cocaine Addiction" className="hero-img" />
...
<br></br><br></br><br></br><br></br>
          ...
          <div className="info-section">
            ...
            <div className="info-image">
              <img src={CocaineImage} alt="Dangers of Cocaine Addiction" />
            </div>
          </div>
        </div><br></br><br></br>
      ...
      <footer className="dashboard-footer">
        <div className="footer-container">
          <div className="footer-brand">
            ...
            <p>
              Recovery Toolkit helps individuals on their path to wellness with engaging games and educational resources for addiction recovery.
            </p>
          </div>
