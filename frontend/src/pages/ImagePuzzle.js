...
import healthyLungs from "../assets/healthylungs.avif";
import smokerLungs from "../assets/smokerlungs.jpg";
import mentalHealth from "../assets/mentalhealth.avif";
import sunset from "../assets/sunset.avif";
import meditation from "../assets/meditation.avif";
...
export default function ImagePuzzle() {
  ...
  const images = [
    { src: healthyLungs, title: "🌿 Healthy Lungs – Breathe Freely" },
    { src: smokerLungs, title: "🚭 Smoker’s Lungs – Dangers of Addiction" },
    { src: mentalHealth, title: "🧠 Mental Health Awareness" },
    { src: sunset, title: "🌅 Hope & New Beginnings" },
    { src: meditation, title: "🧘 Meditation for Inner Peace" },
  ];
