...
import ActionHero from "../assets/softblue.jpeg"; // 👉 replace with action hero image
import ActionVideo from "../assets/growth.mp4"; // 👉 replace with action video

// Section images
import StepsImg from "../assets/bulb.jpeg"; 
import BenefitsImg from "../assets/attention.jpeg"; 
    ...
    <div className="awareness-layout">
      ...
      <main className="main-container">
        ...
        <section className="hero">
          <img src={ActionHero} alt="Action Stage" className="hero-img" />
