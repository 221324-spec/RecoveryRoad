...
import CrystalMethImage from "../assets/softbg.jpg"; // ✅ replace with crystal meth hero image
import CM from "../assets/dd.jpeg"; // ✅ replace with another meth-related image

import "./CrystalMethInfo.css"; // ✅ reusing same CSS

function CrystalMethInfo() {
        ...
        <div className="content">
          ...
          <div className="info-section">
            ...
            <div className="info-image">
              <img src={CM} alt="Dangers of Crystal Meth" />
            </div>
          </div>
        </div><br></br><br></br>
