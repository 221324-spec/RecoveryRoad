...
import OpioidImage from "../assets/softbg.jpg"; // ✅ replace with opioid hero image
import O from "../assets/causes.jpg"; // ✅ replace with an opioid-related image

import "./OpioidsInfo.css"; // ✅ reusing same CSS

function OpioidsInfo() {
        ...
        <div className="content">
          ...
          <div className="info-section">
            ...
            <div className="info-image">
              <img src={O} alt="Dangers of Opioid Addiction" />
            </div>
          </div>
        </div><br></br><br></br>
