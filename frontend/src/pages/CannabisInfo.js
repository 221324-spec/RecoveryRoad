...
import CannabisHero from "../assets/cbg.jpg";   // hero background
import CannabisLeaf from "../assets/cocaine.png";   // section image
import CannabisUsage from "../assets/cbg.jpg";   // section image

import "./CannabisInfo.css"; // ✅ reuse same CSS

function CannabisInfo() {
    ...
    <div className="alcohol-info-layout">
      ...
      <main className="main-container">
        ...
        <section className="hero">
          <img src={CannabisHero} alt="Cannabis Info" className="hero-img" />
        ...
        <div className="content">
          ...
          <div className="info-section">
            ...
            <div className="info-image">
              <img src={CannabisLeaf} alt="Cannabis Leaf" />
            </div>
          </div>
          ...
          <div className="info-section reverse">
            ...
            <div className="info-image">
              <img src={CannabisUsage} alt="Cannabis Usage" />
            </div>
          </div>
          ...
          <div className="info-section">
            ...
            <div className="info-image">
              <img src={CannabisHero} alt="Cannabis Risks" />
            </div>
          </div>
        </div>
