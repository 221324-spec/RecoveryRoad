...
import ProgressHero from "../assets/pastel.jpeg"; // 👉 replace with progress hero image
import ProgressVideo from "../assets/growth.mp4"; // 👉 replace with progress video

// Section images
import StepsImg from "../assets/bulb.jpeg";
import BenefitsImg from "../assets/progress.jpg";
    ...
    <div className="awareness-layout">
      ...
      <main className="main-container">
        ...
        <section className="hero">
          <img src={ProgressHero} alt="Progress Stage" className="hero-img" />
        ...
        <section className="video-section">
          ...
          >
            <video controls>
              <source src={ProgressVideo} type="video/mp4" />
      ...
      <footer className="dashboard-footer">
        <div className="footer-container">
          <div className="footer-brand">
            ...
            />
            <p>
              Recovery Toolkit supports individuals through every stage of
              recovery with education, resources, and motivation. ¹
            </p>
          </div>
