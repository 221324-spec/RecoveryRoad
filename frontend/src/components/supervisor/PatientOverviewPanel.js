...
const PatientOverviewPanel = () => {
  ...
  useEffect(() => {
    const mockPatients = [
      { id: 1, name: 'John Smith', status: 'stable', streakDays: 15, avgMood: 3.5, missedCheckIns: 0, avatar: 'JS', progress: 85, department: 'Outpatient Care' },
      { id: 2, name: 'Sarah Johnson', status: 'mild-risk', streakDays: 9, avgMood: 2.9, missedCheckIns: 1, avatar: 'SJ', progress: 62, department: 'Behavioral Health' },
      { id: 3, name: 'Michael Chen', status: 'high-risk', streakDays: 3, avgMood: 2.1, missedCheckIns: 2, avatar: 'MC', progress: 38, department: 'Intensive Care' },
      { id: 4, name: 'Emily Davis', status: 'stable', streakDays: 21, avgMood: 3.8, missedCheckIns: 0, avatar: 'ED', progress: 92, department: 'Recovery Program' },
      { id: 5, name: 'Robert Wilson', status: 'stable', streakDays: 12, avgMood: 3.3, missedCheckIns: 0, avatar: 'RW', progress: 78, department: 'Outpatient Care' },
      { id: 6, name: 'Lisa Martinez', status: 'mild-risk', streakDays: 7, avgMood: 2.7, missedCheckIns: 1, avatar: 'LM', progress: 55, department: 'Behavioral Health' },
      { id: 7, name: 'David Brown', status: 'stable', streakDays: 30, avgMood: 3.9, missedCheckIns: 0, avatar: 'DB', progress: 95, department: 'Recovery Program' },
      { id: 8, name: 'Jennifer Taylor', status: 'high-risk', streakDays: 2, avgMood: 1.9, missedCheckIns: 3, avatar: 'JT', progress: 28, department: 'Intensive Care' },
    ];
